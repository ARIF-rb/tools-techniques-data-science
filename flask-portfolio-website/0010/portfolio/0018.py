...
def navigation():
    ...
    page = st.sidebar.selectbox(
        "",
        ["Home 🏠", "About ℹ", "Projects 📂", "Skills 🛠", "Contact 📞"]
    )
    st.sidebar.markdown("### Contact Information 📬")
    st.sidebar.write("- 📞 *Phone:* 03014819059")
    st.sidebar.write("- ✉ *Email:* [hamdah.iqbal.hi@gmail.com](mailto:hamdah.iqbal.hi@gmail.com)")
...
def home():
    ...
    with col1:
        with st.expander("About My Passion ❤"):
